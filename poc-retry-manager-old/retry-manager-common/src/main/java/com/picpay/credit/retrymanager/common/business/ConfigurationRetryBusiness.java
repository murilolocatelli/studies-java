...
public class ConfigurationRetryBusiness {
    ...
    public Optional<ConfigurationRetry> findByTopicDlq(String topicDlq) {
        log.info("Finding ConfigurationRetry for topic {}", topicDlq);
        return this.configurationRetryRepository.findByTopicDlq(topicDlq);
    }
